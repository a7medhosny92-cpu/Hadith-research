...
_SHUHRA: dict[tuple[str, ...], str] = {
    ...
    for form, canonical in {
        ...
        # «مولى/كنية+نسبة» descriptors of FAMOUS men the chains cite by the descriptor (coverage gaps —
        # the base name has no «مولى …», so the literal citation misses). Each → his canonical رجال name.
        "نافع مولى عبد الله بن عمر": "نافع أبو عبد الله المدني",               # الثبت الفقيه · مولى ابن عمر (287×)
        "أبو كامل الجحدري": "فضيل بن حسين",                                   # فضيل بن حسين الجحدري · ثقة · شيخ مسلم
        "أبو داود الطيالسي": "سليمان بن داود الطيالسي",                        # سليمان بن داود · ثقة حافظ · ت204
        "سمي مولى أبي بكر": "سمي مولى أبي بكر بن عبد الرحمن",                   # سُمَيٌّ المدنيُّ · ثقة (لا اليمانيُّ المجهول)
        "أبو العباس محمد بن يعقوب": "محمد بن يعقوب الأصم",                      # الأصمُّ النيسابوريُّ · شيخُ الحاكم (المتأخّر)
    }.items()
}

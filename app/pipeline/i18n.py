...
_PACKS: Dict[str, dict] = {
    ...
    "ar": {
        ...
        "hooks": [
            "لم يشرح لك أحد هذا عن {topic}.",
            "سأغيّر نظرتك إلى {topic}.",
            "ثلاثة أشياء عن {topic} ستذهلك.",
            "السر في {topic} الذي لا يخبرك به الخبراء.",
        ],
        "ctas": [
            "احفظ هذا الفيديو وتابعني للمزيد عن {topic}.",
            "أيّها فاجأك أكثر؟ اكتب في التعليقات.",
            "شاركه مع من يجب أن يعرف هذا عن {topic}.",
        ],
        "points": [
            "النقطة {n}: {topic} يعمل بشكل أفضل عندما تبدأ بالأساسيات.",
            "النقطة {n}: معظم الناس يتجاهلون هذه التفصيلة عن {topic}.",
            "النقطة {n}: تغيير صغير هنا يحدث فرقاً كبيراً.",
            "النقطة {n}: هذا هو الخطأ الأول الذي يجب تجنّبه مع {topic}.",
            "النقطة {n}: جرّب هذا لسبعة أيام وسترى النتائج.",
        ],
        "quiz_intro": "اختبار سريع عن {topic}. كم ستصيب؟",
        "quiz_q": [
            "هل تعرف حقاً هذا عن {topic}؟",
            "سؤال: ماذا يحدث مع {topic}؟",
            "خمّن: ما الحقيقة عن {topic}؟",
        ],
        "quiz_a": [
            "الإجابة أبسط مما تظن: ابدأ بالأساسيات.",
            "بالضبط: معظم الناس يخطئون هنا تماماً.",
            "مفاجأة: إنه عكس ما كنت تظن.",
        ],
        "quiz_outro": "كم أصبت عن {topic}؟ اكتب وتابعني!",
        "top_intro": "أفضل {n} نصائح عن {topic}. الرقم واحد سيفاجئك.",
        "rank": "رقم {rank}: نصيحة عن {topic} {line}",
        "rank_lines": [
            "لأنها تحدث فرقاً كل يوم.",
            "وقلّة من يستغلّها بشكل صحيح.",
            "تغيّر كل شيء إذا طبّقتها الآن.",
            "السر الذي يحتفظ به الخبراء.",
        ],
        "top_cta": "أيّها ستجرّب أولاً؟ احفظ الفيديو وتابعني للمزيد عن {topic}.",
        "story": [
            ("hook", "سأحكي لك قصة عن {topic} تغيّر كل شيء.", "قصة"),
            ("beat", "في البداية بدا {topic} بسيطاً.", "١"),
            ("beat", "ثم جاءت المشكلة التي لم يتوقعها أحد.", "٢"),
            ("beat", "نقطة التحول كانت فهم شيء عن {topic}.", "٣"),
            ("beat", "من تلك اللحظة تغيّر كل شيء للأفضل.", "٤"),
            ("cta", "العبرة؟ لا تستسلم مع {topic}. تابعني للجزء الثاني.", "تابعني"),
        ],
